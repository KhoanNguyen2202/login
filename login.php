...
$servername	=	"database-server-lab7.cpwmcve9k3lz.ap-southeast-1.rds.amazonaws.com";
$username  =  "admin";
$password  =  "123456789";
$dbname  =  "myDB";
...
//  Kiểm tra số lượng bản ghi trả về if  ($result->num_rows  >  0)  {
//  Nếu  có, đăng nhập thành công echo  "Bạn  đã  đăng  nhập  thành  công";
